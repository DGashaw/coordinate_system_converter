...
// the positive x-axis measured in anti-clockwise direction. The value of the angle can be positive/negative
...
assert.strictEqual(cartCoordinate.toString(), '(3,4)', 'The string representation of the Cartesian object must be equal to (3,4)');

cartCoordinate.xCoordinate = -4;

assert.strictEqual(cartCoordinate.toString(), '(-4,4)', 'The string representation of the Cartesian object must be equal to (-4,4) after setting a new x-ccordinate value');
...
assert.strictEqual(`${polarCoordinate.toString()}`, '(5,53)', 'The string representation of polar coordinate object have a value of (5,53)');
...
assert.strictEqual(polarCoordinateTwo.toString(), '(5,53)', 'The string represenation of the polarCoordinateTwo object is (5,53)');
